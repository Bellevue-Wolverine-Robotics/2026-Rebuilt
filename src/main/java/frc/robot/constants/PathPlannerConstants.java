...
public class PathPlannerConstants {
    public static final double TRANSLATIONAL_PID_KP = 5.0;
    public static final double TRANSLATIONAL_PID_KI = 0.0;
    public static final double TRANSLATIONAL_PID_KD = 0.0;
    ...
    public static final double MAXIMUM_ACCELERATION_METERS = 2.5;
